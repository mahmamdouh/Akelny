...
# Final Deployment Script - TypeScript Fixed
echo "🚀 Final deployment for Akelny Backend (TypeScript Fixed)..."
...
echo "   - Removed rootDir restriction"
echo "   - Fixed shared types import paths"
echo "   - Resolved community controller type issues"
...
if echo "$HEALTH_RESPONSE" | grep -q "healthy"; then
    ...
    echo ""
    echo "✅ Full TypeScript backend deployed successfully"
